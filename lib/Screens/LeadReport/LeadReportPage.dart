                        ...
                        Container(
                          ...
                          child: Obx(
                            () => DropdownButtonFormField<String>(
                              ...
                              items: ['All', 'WARM', 'COLD'].map((status) {
                                return DropdownMenuItem(
    ...
    builder: (_) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Export Lead Report As', // Changed text
              ...
              children: [
                ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ...
                    controller.downloadAllLeadsDataAsPDF(context); // Corrected method call
                  },
                  style: ElevatedButton.styleFrom(
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.pop(context);
                    controller.downloadAllLeadsDataAsExcel(context); // Corrected method call
                  },
                  style: ElevatedButton.styleFrom(
