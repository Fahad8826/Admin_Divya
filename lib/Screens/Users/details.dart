...
class _UserDetailPageState extends State<UserDetailPage>
  ...
  final AddUserController _addUserController = Get.put(
    AddUserController(),
  ...
  Map<String, dynamic>? _locationData; // Store location data
  ...
  void initState() {
    ...
    _fetchLocationData(); // Fetch location data on init
  }
  ...
  // Fetch location data using AddUserController
  ...
  Future<void> _deleteUser() async {
    ...
    if (confirm == true) {
      ...
      try {
        ...
        if (userToDelete == null || userToDelete.uid != widget.userId) {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              _buildLocationSection(), // New Location Section
              const SizedBox(height: 24),
    ...
    return _buildSection(
      ...
      children: [
        ...
        _buildInfoRow(
          ...
          value: _locationData?['lastLocationUpdate'] != null
              ? _locationData!['lastLocationUpdate'].toString()
              : 'Not available',
        ),
      ],
    );
